...
- If FACTS include dataTimelinessNote, briefly acknowledge it: occupancy numbers are historical-pattern forecasts from stored snapshots, not live parking availability. Keep this brief and do not contradict the selected lot in FACTS.
